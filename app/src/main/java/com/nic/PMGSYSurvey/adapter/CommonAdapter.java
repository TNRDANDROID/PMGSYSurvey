package com.nic.PMGSYSurvey.adapter;
...
public class CommonAdapter extends BaseAdapter {
    private List<PMGSYSurvey> pmgsySurveys;
    private Context mContext;
    private String type;


    public CommonAdapter(Context mContext, List<PMGSYSurvey> pmgsySurvey, String type) {
...
//        TextView tv_type = (TextView) view.findViewById(R.id.tv_spinner_item);
        ...
        PMGSYSurvey pmgsySurvey = pmgsySurveys.get(position);
